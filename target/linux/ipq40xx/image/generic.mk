...
define Device/netgear_rbx50_v2
	$(call Device/DniImage)
	DEVICE_VENDOR := NETGEAR
	NETGEAR_HW_ID := 29765352+0+4000+512+2x2+2x2+4x4
	SOC := qcom-ipq4019
...
define Device/netgear_rbr50_v2
	$(call Device/netgear_rbx50_v2)
	DEVICE_MODEL := RBR50
	DEVICE_VARIANT := v2
	DEVICE_DTS := qcom-ipq4019-rbr50-v2
	SUPPORTED_DEVICES := netgear,rbr50,v2
	NAND_SIZE := 512m
	KERNEL_SIZE := 6815744
	...
	NETGEAR_BOARD_ID := RBR50
endef
TARGET_DEVICES += netgear_rbr50_v2

define Device/netgear_rbs50_v2
	$(call Device/netgear_rbx50_v2)
	DEVICE_MODEL := RBS50
	DEVICE_VARIANT := v2
	DEVICE_DTS := qcom-ipq4019-rbs50-v2
	SUPPORTED_DEVICES := netgear,rbs50,v2
	NAND_SIZE := 128m
	KERNEL_SIZE := 6815744
	...
	NETGEAR_BOARD_ID := RBS50
endef
TARGET_DEVICES += netgear_rbs50_v2
